...
README_ITEMS = [
    "[Version {0}](https://github.com/sepandhaghighi/pixora/archive/v{0}.zip)",
    "pip install pixora=={0}"]

SETUP_ITEMS = [
    "version='{0}'",
    "https://github.com/sepandhaghighi/pixora/tarball/v{0}"]

CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/sepandhaghighi/pixora/compare/v{0}...dev",
    "[{0}]:"]

PARAMS_ITEMS = ['PIXORA_VERSION = "{0}"']
ISSUE_TEMPLATE_ITEMS = ["- Pixora {0}"]
